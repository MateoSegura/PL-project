...
// #define TIME_TO_POWER_SAVE_START_S 20
...
//         //     // if (serial_debugging_enabled)
//         //     // {
//         //     //     Serial.println("[ERR]  Invalid Device Mode, There's been an error. Resetting Unit...");
//         //     // }
//         //     // sendBLEMessage("[ERR]  Invalid Device Mode, There's been an error. Resetting Unit...");
//         //     // ESP.restart();
//         //     break;
//         // }
//     }
...
//                 if (serial_debugging_enabled)
//                 {
//                     Serial.println("[DIS]  Erasing Message");
//                 }
//                 tft.fillRect(0, 60, 241, 76, ST77XX_BLACK);
