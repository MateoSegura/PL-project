...
// //TODO: INSTRUCTION PTnnn, fix which one sets the amount of pills per tray (loaded), and how many pill slots there are per tray
...
// #define DEFAULT_STEPS_PER_PILL 1135
...
// #define DEFAULT_TIME_TO_POWER_SAVE_START_D 10
// #define DEFAULT_TIME_TO_POWER_SAVE_START_A 20

// #define NUMBER_OF_STEPS_MOVED_IN_TEST_MODE 40

// long initial_buzzer_sound_time = 0;
// bool buzzer_first_time = true;
// bool buzzer_state;
// uint8_t buzzer_sound_count;
...
// #define BLENAME "PILL LOCKER POCKET MODEL 1"
...
//     uint16_t motor_steps_per_pill[NUMBER_OF_TRAYS];
//     uint16_t motor_rpm;
...
//         //Motor RPMS
//         this->motor_rpm = DEFAULT_MOTOR_RPM;
...
//             this->loaded_pills_per_tray[i] = DEFAULT_PILLS_PER_TRAY;
...
//         //MOTOR RPMS
//         verifyMemorySave("mot_rpm", myNVS.setInt("mot_rpm", this->motor_rpm));
...
//             verifyMemorySave(("pills_dis_" + i), myNVS.setInt(("pills_dis_" + i), this->pills_dispensed[i]));
...
//         //MOTOR RPMS
//         this->motor_rpm = myNVS.getInt("mot_rpm");
...
//             this->pills_dispensed[i] = myNVS.getInt(("pills_dis_" + i));
...
//         2,         /* priority of the task: 0 to 25, 25 being the highest*/
...
//                             this_device_settings.pills_remaining[i] = temp;
//                         }
//                         portEXIT_CRITICAL(&mux);
...
//                     //Set values to device settings (will not be saved until save instruction. if utils. mode is exited, settings will revert to previous)
//                     portENTER_CRITICAL(&mux);
//                     this_device_settings.motor_rpm = speed;
//                     portEXIT_CRITICAL(&mux);
...
//                 //BEGIN MOTORS
//                 motor1.begin(this_device_settings.motor_rpm, MICROSTEPS);
//                 motor2.begin(this_device_settings.motor_rpm, MICROSTEPS);
//                 motor3.begin(this_device_settings.motor_rpm, MICROSTEPS);
...
//     for (int i = 0; i < NUMBER_OF_TRAYS; i++)
//     {
//         total_steps[i] = this_device_settings.motor_steps_per_pill[i] * this_device_settings.loaded_pills_per_tray[i];
//     }
//     portEXIT_CRITICAL(&mux);
...
//     for (int i = 0; i < NUMBER_OF_TRAYS; i++)
//     {
//         _missed_dosages[i] = this_device_settings.missed_dosages[i];
//         _pill_slots_per_tray[i] = this_device_settings.pill_slots_per_tray[i];
//         _pills_remaining[i] = this_device_settings.pills_remaining[i];
...
//         if (this_device_settings.current_device_mode[0] == 'D' && alarm_count < alarm_length)
//         {
//             portENTER_CRITICAL(&mux);
...
//             uint16_t motor_steps = _number_of_trays_to_open[0] * this_device_settings.motor_steps_per_pill[0];
...
//             for (int i = 0; i < NUMBER_OF_TRAYS; i++)
//             {
//                 this_device_settings.pills_dispensed[i] = this_device_settings.pills_dispensed[i] + 1;
//                 this_device_settings.pills_remaining[i] = this_device_settings.pills_remaining[i] - 1;
//             }
//             portEXIT_CRITICAL(&mux);
...
//             for (int i = 0; i < NUMBER_OF_TRAYS; i++)
//             {
//                 this_device_settings.missed_dosages[i] = this_device_settings.missed_dosages[i] + 1;
//             }
//             portEXIT_CRITICAL(&mux);

//             Serial.print("[DEM]  Number of pills remaining:  ");
//             Serial.println(this_device_settings.pills_remaining[0]);

//             Serial.print("[DEM]  Number of missed dosages:  ");
//             Serial.println(this_device_settings.missed_dosages[0]);
//         }

//         //Go back to main menu once done
//         if (this_device_settings.missed_dosages[0] == 0)
//         {
//             if (this_device_settings.pills_remaining[0] == 0)
//             {
//                 if (this_device_settings.current_device_mode[0] == 'D')
//                 {
...
//         else
//         {
//             if (this_device_settings.missed_dosages[0] + this_device_settings.pills_dispensed[0] == this_device_settings.loaded_pills_per_tray[0])
//             {
//                 if (this_device_settings.current_device_mode[0] == 'D')
//                 {
//                     this_device_settings.exitDemoMode();
...
//         Serial.println(this_device_settings.missed_dosages[0] + this_device_settings.pills_dispensed[0]);
...
//         settings_message += this_device_settings.motor_rpm;
